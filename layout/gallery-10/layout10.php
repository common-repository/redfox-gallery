...
<div class="rf_gallery_10 rf_gallery_<?=$id?>">
	<div class="rf_10_gallery">
		<div class="container-fluid">
			...
			<div class="row content">
				...
				<?php array_map(function($img_title,$attach_url,$img_url){ ?>
					<div class="rf_10_wrapper <?php echo $GLOBALS['column'];?>">
						<div class="img_wrapper">
							<div class="img_title">
								<?php if($GLOBALS['img_title_display']==1){ ?>
									<a class="info" href="<?php echo esc_url($attach_url) ?>" target="<?php echo esc_attr($GLOBALS['target']); ?>">
										<h3 class="title">
